...
#include "L321_maxNumber.h"

vector<int> L321_maxNumber::MaxSubsequence(vector<int> &nums, int k) {
...
vector<int> L321_maxNumber::merge(vector<int> &subsequence1, vector<int> &subsequence2) {
...
int L321_maxNumber::compare(vector<int>& subsequence1, int index1, vector<int>& subsequence2, int index2) {
    int x = subsequence1.size(), y = subsequence2.size();
...
vector<int> L321_maxNumber::maxNumber(vector<int> &nums1, vector<int> &nums2, int k) {
